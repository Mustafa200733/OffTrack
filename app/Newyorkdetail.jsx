...
const trip = { city: "New York" };

export default function Newyorkdetail() {
  ...
  return (
    <View>
      ...
      <Image source={require("./images/detnew.png")} style={styles.image} />

      <Text style={styles.dayTitle}>Day 1</Text>
      <Text style={styles.storyText}>
        New York felt huge and full of energy from the first moment. Skyscrapers, busy streets, and so much to see.
      </Text>

      <Text style={styles.dayTitle}>Day 2</Text>
      <Text style={styles.storyText}>
        I explored iconic spots, enjoyed the city atmosphere, and ended the day with great food.
      </Text>
