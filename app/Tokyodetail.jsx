...
const trip = { city: "Tokyo" };

export default function Tokyodetail() {
  ...
  return (
    <View>
      ...
      <Image source={require("./images/dettok.png")} style={styles.image} />

      <Text style={styles.dayTitle}>Day 1</Text>
      <Text style={styles.storyText}>
        Tokyo is a fascinating mix of modern life and tradition. The city feels fast, clean, and full of surprises.
      </Text>

      <Text style={styles.dayTitle}>Day 2</Text>
      <Text style={styles.storyText}>
        I visited famous areas, tried local food, and enjoyed the unique energy that makes Tokyo unforgettable.
      </Text>
