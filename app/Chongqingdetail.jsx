...
export default function Chongqingdetail() {
  ...
  return (
    <View>
      <Text style={styles.Text}>Chongqing</Text>
      <Link href="/home">
            <Image source={require('./images/kruis.png')} 
            style={styles.kruis}
            ></Image>
      </Link>
      <Image source={require('./images/chongqingdet.png')}
                              style={styles.image}
>
