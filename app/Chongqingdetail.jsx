...
const trip = { city: "Chongqing" };

export default function Chongqingdetail() {
  ...
  return (
    <View>
      ...
      <Image source={require("./images/chongqingdet.png")} style={styles.image} />

      <Text style={styles.dayTitle}>Day 1</Text>
      <Text style={styles.storyText}>
        Chongqing amazed me with its hills, skyline, and dynamic streets. The city feels powerful and full of life.
      </Text>

      <Text style={styles.dayTitle}>Day 2</Text>
      <Text style={styles.storyText}>
        I explored local neighborhoods, enjoyed the food scene, and discovered the unique character of Chongqing.
      </Text>
